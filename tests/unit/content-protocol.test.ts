...
describe('content-script request build fence', () => {
  ...
  it('exports one exact-current-build request type for every production operation', () => {
    ...
    const operations = {
      ...
      CONTENT_API_COLLECT_REQUEST: 'list.apiCollect',
      CONTENT_API_COLLECT_OWNER_PAGE_REQUEST: 'list.apiCollectOwnerPage',
      CONTENT_API_COLLECT_ARTICLE_REQUEST: 'document.apiCollectArticle',
